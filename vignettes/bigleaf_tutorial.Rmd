...
Note that for the `install_bitbucket` command to work on Windows, [Rtools](https://cran.r-project.org/bin/windows/Rtools/) must be installed. After installation, the package can be loaded:
